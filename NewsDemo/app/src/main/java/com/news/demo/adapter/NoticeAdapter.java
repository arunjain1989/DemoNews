...
import com.news.demo.main_activity.RecyclerItemClickListener;
import com.news.demo.model.Notice;
...
public class NoticeAdapter extends RecyclerView.Adapter<NoticeAdapter.EmployeeViewHolder> {
    ...
    public void onBindViewHolder(EmployeeViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.txtNoticeBrief.setText(dataList.get(position).getByline());
        holder.txtNoticeFilePath.setText(dataList.get(position).getPublished_date());
